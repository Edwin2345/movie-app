...
function Modal({closeModal, title, movie, year, score, genre}) {
  ...
  return (
    <>
        <div
      className="fixed top-0 bottom-0 left-0 right-0 bg-[rgba(0,0,0,0.4)] flex justify-center items-center z-[1]"
      onClick={() => {
        // close modal when outside of modal is clicked
        closeModal();
      }}
    >
      <div className="justify-center my-3 items-center overflow-x-hidden  fixed inset-0 outline-none focus:outline-none">
