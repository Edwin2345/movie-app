            ...
            <form onSubmit={submitHandler}> 
              <div className="relative flex items-center ts:ml-3">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  ...
                  <input value={searchTerm} onChange={changeHandler} type="search" id="default-search" class="block w-full p-4 pl-10 text-[0.54rem] md:text-[1.1rem] ts:text-[0.56rem] xs:text-[0.66rem] text-gray-900 border border-gray-300 rounded-[15px] bg-gray-50 focus:border-black-500 font-bold" placeholder="Search Movies, TV Shows..." required />
                  <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-[0.4rem] md:text-[1.2rem] ts:text-[0.55rem] xs:text-[0.85rem]  px-1 py-[0.4rem]">Search</button> 
            </div>
            </form>
          </div>
